...
export default function LandingHero({
  ...
  return (
    <section className="landing-enter grid items-start gap-12 pt-16 lg:min-h-[56vh] lg:grid-cols-[1.14fr_0.86fr] lg:pt-24">
      <div className="text-center lg:text-left">
        ...
        <h1 className="heading-rise mt-6 text-[clamp(2.8rem,5vw,5.5rem)] font-bold leading-[1.02] text-white">
          Ship Cleaner Code,
        ...
        <p className="mx-auto mt-6 max-w-3xl text-base leading-8 text-white/65 sm:text-lg lg:mx-0">
        ...
        <form onSubmit={onSubmit} className="cta-rise mx-auto mt-10 flex max-w-3xl flex-col gap-3 sm:flex-row lg:mx-0">
          <input
            type="text"
        ...
        {isLoggedIn ? (
          <div className="mx-auto mt-3 max-w-3xl lg:mx-0">
            <button
              type="button"
              onClick={onAnalyzeOwnRepos}
              className="w-full rounded-xl border border-cyan-300/35 bg-cyan-400/10 px-5 py-3 text-sm font-semibold text-cyan-100 transition hover:bg-cyan-400/20 sm:w-auto"
            >
      ...
      <div className="panel-rise rounded-2xl border border-white/15 bg-slate-950/70 p-6 backdrop-blur-md shadow-2xl shadow-cyan-900/30">
